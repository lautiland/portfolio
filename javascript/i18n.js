...
var translations = {
  ...
  bio: {
    ...
    p2: {
      es: "Este portfolio reúne trabajos prácticos universitarios y proyectos personales donde aplico estructuras de datos, patrones de diseño y arquitectura de sistemas en lenguajes como Rust, Java y Python. La mayoría son desarrollos colaborativos con Git y documentación técnica detallada, y en ellos aprendí a trabajar en equipo bajo metodologías ágiles, algo en lo que me siento cómodo. Estoy buscando una pasantía o primer empleo que me permita seguir formándome académicamente mientras me desarrollo profesionalmente.",
      en: "This portfolio gathers university coursework and personal projects where I apply data structures, design patterns and systems architecture in languages like Rust, Java and Python. Most are collaborative developments with Git and detailed technical documentation, and through them I learned to work in teams under agile methodologies, something I'm comfortable with. I'm looking for an internship or first job that lets me keep growing academically while developing professionally.",
    },
  },
